...
export default {
    ...
    methods: {
        async fetchVideos() {
            const response = await axios.get('https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=PL6M4J55WQYzwarWRbKAO_uYApaqG4YaoD&key=AIzaSyDsLvG31mXz6L3cD17_CHmfnp2zz9S5ooE');
